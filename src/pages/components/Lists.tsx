...
const ListItemNotButton: OverridableComponent<ListItemTypeMap<{ button?: false }, 'li'>> = styled(MuiListItem)(spacing)
...
class NestedList extends React.Component<{}, {open: boolean}> {
  state = {
    open: true
  };

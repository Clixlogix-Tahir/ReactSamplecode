...
class SimpleSnackbar extends React.Component {
  ...
  handleClose = (event: React.SyntheticEvent<any, Event>, reason?: SnackbarCloseReason) => {
    if (reason === "clickaway") {
      return;
    }
...
class PositionedSnackbar extends React.Component {
  ...
  handleClick = (state: {vertical: string, horizontal: string}) => () => {
...
class ConsecutiveSnackbar extends React.Component<{}, {open: boolean, messageInfo: {key?: number, message?: string} | undefined} > {
  queue: Array<{message: string, key: number}> = [];
...
class DirectionSnackbar extends React.Component {
  ...
  handleClick = (Transition: (props: SlideProps) => JSX.Element ) => () => {
  ...
  transitionLeft(props: SlideProps) {
    return <Slide {...props} direction="left" />;
  }

  transitionUp(props: SlideProps) {
    return <Slide {...props} direction="up" />;
  }

  transitionRight(props: SlideProps) {

...
type SelectedMenuStateType = {
  anchorEl: null | HTMLDivElement
  selectedIndex: number
}

class SelectedMenu extends React.Component<{}, SelectedMenuStateType> {
  constructor(public props: {}, public options: Array<string>) {
    super(props);
  ...
  handleClickListItem = (event: React.MouseEvent<HTMLDivElement, MouseEvent>) => {
    this.setState({ anchorEl: event.currentTarget });
  };

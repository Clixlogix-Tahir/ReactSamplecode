...
class SimpleSelect extends React.Component<{}, {age?: string, name?: string, labelWidth?: number}> {
  state = {
    age: "",
    name: "hai",
    labelWidth: 0
  ...
  componentDidMount() {
    const ReactElem = ReactDOM.findDOMNode(this.InputLabelRef) as HTMLElement
    this.setState({
      labelWidth: this.InputLabelRef ? ReactElem.offsetWidth : 0
    });
  }

  handleChange = (event: React.ChangeEvent<{ name?: string | undefined; value: unknown; }>) => {
    return event.target.name ? this.setState({ [event.target.name]: event.target.value }) : null
  };
...
class MultipleSelect extends React.Component<{}, {name: Array<string> }> {
  state = {
            ...
            <FormControl m={2}>
              ...
              <Select
                ...
                renderValue={(selected: any) => (
                  <div>
                    {selected.map((value: string | number | undefined) => (
...
class DialogSelect extends React.Component {
  ...
  handleChange = (name: string) => (event: React.ChangeEvent<{name?: string | undefined;value: unknown;}>) => {

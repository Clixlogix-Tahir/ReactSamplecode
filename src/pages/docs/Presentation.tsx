...
const Demo: React.FC<DemoPropsType> = ({ setTheme, id, title, img }) => {
...
const ConnectedDemo = connect(MapState, {setTheme})(Demo);

function DemoList({ width }: WithWidth) {
  return (
...
function Presentation({ width }: WithWidth) {
  return (
    <React.Fragment>
      <Introduction />
